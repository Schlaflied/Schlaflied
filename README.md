...
### For recruiters: If you are still using stupid ATS and AI filter to select the candidate, you will NEVER find the right person for your organization. You said you paid for Linkedin Premium? I have achieved a 47% response rate using my [Job autopilot](https://github.com/Schlaflied/job-autopilot).I build this pipeline which your organization doesn't even have one.
