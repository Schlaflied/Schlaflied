...
- [career-ops](https://github.com/santifer/career-ops) core — **60个PR已合并**，包括SQLite存储层架构RFC（#918→#919）、无冲突per-plugin registry架构（#1402）、jurisdiction-compliance-lens系列六个已合并成员（#2020/#2029/#2031/#2034/#2038/#2041），完整列表见上方英文区的可展开清单；现在负责storage-layer方向并参与issue triage
